...
class ActionController extends AbstractActionController {
    ...
    public function __construct() {
        if(!is_null($this->slug)){
            $this->entity       = ($this->entity)       ? $this->entity         : 'Application\Document\\'. ucfirst($this->slug);
            $this->service      = ($this->service)        ? $this->service        : 'Service\\'. ucfirst($this->slug);
    ...
    protected function getEm(){
        return $this->dm = $this->getServiceLocator()->get('doctrine.documentmanager.odm_default');
    }
